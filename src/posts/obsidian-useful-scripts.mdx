...
import postImg0 from "../assets/img/obsidian_useful_scripts/Pasted image 20231122200039.png";
import postImg1 from "../assets/img/obsidian_useful_scripts/Pasted image 20231122200616.png";
import postImg2 from "../assets/img/obsidian_useful_scripts/Pasted image 20231122200734.png";
import postImg3 from "../assets/img/obsidian_useful_scripts/Pasted image 20231122200838.png";
import postImg4 from "../assets/img/obsidian_useful_scripts/Pasted image 20231122200909.png";
import postImg5 from "../assets/img/obsidian_useful_scripts/Pasted image 20231122200932.png";
import postImg6 from "../assets/img/obsidian_useful_scripts/Pasted image 20231122201006.png";
import postImg7 from "../assets/img/obsidian_useful_scripts/Pasted image 20231122201028.png";
import postImg8 from "../assets/img/obsidian_useful_scripts/Pasted image 20231122201054.png";

Alright, in this post I'd like to share some Obsidian templates & scripts that have piled up over the busy year that I had.

<PostImage src={postImg0} alt="my vault" width={500} caption="My vault :)" />
...
<PostImage src={postImg1} alt="" width={400} />
...
<PostImage src={postImg2} alt="" width={400} />
...
<PostImage src={postImg3} alt="" width={400} />
...
<PostImage src={postImg4} alt="" width={400} />
...
<PostImage src={postImg5} alt="" width={400} />
...
<PostImage src={postImg6} alt="" width={400} />
...
<PostImage src={postImg7} alt="" width={400} />
...
<PostImage src={postImg8} alt="" width={400} />
