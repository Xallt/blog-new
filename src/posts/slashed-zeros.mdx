...
---
import postImg0 from "../assets/img/slashed-zeros/with-slashed-zeros.png";
import postImg1 from "../assets/img/slashed-zeros/without-slashed-zeros.png";
...
|:---:|:---:|
|<PostImage src={postImg0} alt="" />| <PostImage src={postImg1} alt="" />|
