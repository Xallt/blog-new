...
import postImg0 from "../assets/img/color-palette/old-blackgold-palette.png";

UPD: I already updated my website, so it doesn't use this black-gold palette anymore, but here's the screenshot:

<PostImage src={postImg0} alt="The look of the old website with the black-gold palette" width={500} caption="It was based on the [Eleventy-Duo](https://github.com/yinkakun/eleventy-duo) theme" />
