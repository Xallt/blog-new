...
import postImg0 from "../assets/img/c-programming-setup/vscode-screenshot.png";
import postImg1 from "../assets/img/c-programming-setup/linter-issue.png";
import postImg2 from "../assets/img/c-programming-setup/debugger-screenshot.png";
...
<PostImage src={postImg0} alt="IDE screenshot" caption="How my IDE setup looks" />
...
<PostImage src={postImg1} alt="Linter Issue" caption="Some examples of things that the linter gets weirdly wrong" />
...
Clangd also has [clangd-tidy](https://clangd.llvm.org/features#clangd-tidy-checks) with advanced code checks -- to enable, add this to the `.clangd` file:
```
CompileFlags:
  CompilationDatabase: build/
  ClangdTidy:
...
<PostImage src={postImg2} alt="Debugger screenshot" caption="How the debugger looks. Very convenient, and snappy fast for C++" />
