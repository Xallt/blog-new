...
import postImg0 from "../assets/img/camp_paper/colmap_colliseum.png";
import postImg1 from "../assets/img/camp_paper/excalidraw_intrinsic.png";
...
<PostImage src={postImg0} alt="" caption="COLMAP: Reconstruction of the area around the Colloseum from lots of tourist photos" />
...
<PostImage src={postImg1} alt="Excalidraw drawing intrinsic parameters visualization" width={500} caption="An old drawing of mine I made to derive the values in the intrinsic matrix" />
