...
import postImg0 from "../assets/img/homography/Pasted image 20241228140316.png";
import postImg1 from "../assets/img/homography/Screenshot 2024-12-28 at 14.34.29.png";
import postImg2 from "../assets/img/homography/homography-derivation-1.jpg";
import postImg3 from "../assets/img/homography/homography-derivation-2.jpg";
...
<PostImage src={postImg0} alt="The HPatches dataset mention" width={600} caption="Mention of the HPatches dataset in the ALIKE paper" />
...
<PostImage src={postImg1} alt="Visualization of the mapping between cameras" width={600} caption="Mapping between cameras, in the case of a sphere and a plate" />
...
<div class="post-img-row">
  <PostImage src={postImg2} alt="Homography derivation 1" height={400} />
  <PostImage src={postImg3} alt="Homography derivation 2" height={400} />
</div>
